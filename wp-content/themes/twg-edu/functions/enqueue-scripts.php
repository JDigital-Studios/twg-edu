...
function site_scripts() {
  ...
  $theme_version = wp_get_theme()->get('Version');
    ...
    // Bundle JS file
    wp_enqueue_script( 'main-js', get_template_directory_uri() . '/dist/main.js', array('jquery'), $theme_version, 'true' );
    ...
    wp_enqueue_style( 'site-css', get_template_directory_uri() . '/dist/main.css', array(), $theme_version, 'all' );
